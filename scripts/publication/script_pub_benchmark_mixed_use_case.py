...
if __name__ == '__main__':
    ...
    # bm.to_pickle(os.path.join(FileUtils.data_dir, "paper_04", "test_V06.pickle"))
    ...
    bm = main(d_list=[24, 48, 72, 96],  # [96, ]
              ...
              parallelize=True,
              plot_3d_upr=True, plot_3d_time=True, plot_barchart_upr=True, plot_barchart_time=True)
    bm.to_pickle(os.path.join(FileUtils.data_dir, "paper_04", "test_V06_lpvg_gurobi.pickle"))
